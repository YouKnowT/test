                    ...
                    <div class="ibox-content">
                        <form   class="form-horizontal" method="post" action="UserInfoServlet?opr=courseadd">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="teacher"  name="xxx"/>A类   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="student" name="xxx"/>B类&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="student" name="xxx"/>C类&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         其它  &nbsp; &nbsp;<input type="text" id="student" name="xxx"/>
                             ...
                             <div class="form-group">
                                ...
                                <input type="radio" id="teacher"  name="xxx"/>一等奖   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="student" name="xxx"/>二等奖&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="student" name="xxx"/>三等奖&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         其它  &nbsp; &nbsp;<input type="text" id="student" name="xxx"/>
