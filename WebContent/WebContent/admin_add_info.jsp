                    ...
                    <div class="ibox-content">
                        <form   class="form-horizontal" method="post" action="UserInfoServlet?opr=courseadd">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="category1"  name="category"/>A类   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="category2" name="category"/>B类&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="category3" name="category"/>C类&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         其它  &nbsp; &nbsp;<input type="text" id="category4" name="category"/>
                             ...
                             <div class="form-group">
                                ...
                                <input type="radio" id="item1"  name="item"/>一等奖   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="item2" name="item"/>二等奖&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" id="item3" name="item"/>三等奖&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         其它  &nbsp; &nbsp;<input type="text" id="item4" name="item"/>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-3"> 
                                    <input type="file" multiple id="imgLocal1" accept="image/*"  />
                                </div>
                            </div> 
                              <div class="form-group">
                                <label class="col-sm-2 control-label">指导证书:</label>
								<div class="col-sm-3"> 
                                    <input type="file" multiple id="imgLocal2" accept="image/*"  />
                                </div>
