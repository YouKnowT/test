...
<!-- 										<td>${target.course_name }<span class="pie">4,9</span></td> -->
<!-- 										<td>${target.target }</td>  -->
<!-- 										<td> -->
<!-- 											<a href="UserInfoServlet?opr=scoreid&id=${target.id }&target=${target.target}&course_name=${target.course_name}"> -->
<!-- 														<button type="button" class="btn btn-sm btn-primary">评价课程</button> -->
<!-- 														<button type="button" class="btn btn-sm btn-primary">评价课程</button> -->
