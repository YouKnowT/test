						...
						<div class="table-responsive">
							<table class="table table-striped">
								...
								<c:foreach items="${Student}" var="student">
									<tr>
										<td>${student.user_count  }</td>
										<td>${student.name  }</td>
										<td>${student.password  }</td>
										<td>

											<a href="stu_modify.jsp">
												<button type="button" class="btn btn-sm btn-primary" name="but" value="0">修改</button></a>
												<button type="button" class="btn btn-sm btn-primary" name="but" value="1">删除</button>
