...
<%--										<td>${target.class_name }</td> --%>
										...
										<td>${competition.suser_count }</td>
										<td>${competition.tuser_count }</td>
<%--										<td>${target.scoure_content }</td> --%>
										<td>${competition.category }</td>
										<td>${competition.item }</td>
										<td>
											<a href="admin_add_info.html">
											<button type="button" class="btn btn-sm btn-primary" name="but" value="0" id="modify">修改</button></a>
											<button type="button" class="btn btn-sm btn-primary" name="but" value="1" id="delete">删除</button>
										</td>
									</tr>
									</c:forEach>
								</tbody>
